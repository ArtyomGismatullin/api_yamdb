...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for row in csv_reader:
            ...
            title_obj = Title.objects.get_or_create(
                id=row[0],
                name=row[1],
                year=row[2],
        ...
        for row in csv_reader:
            ...
            genre_title_obj = GenreTitle.objects.get_or_create(
                id=row[0],
                genre=genre_obj,
                title=title_obj
            )
        ...
        for row in csv_reader:
            ...
            review_obj = Review.objects.get_or_create(
                id=row[0],
                title=title_obj,
                text=row[2],
                author=user_obj,
        ...
        for row in csv_reader:
            ...
            user_obj = get_object_or_404(User, id=row[3])
            comment_obj = Comment.objects.get_or_create(
                id=row[0],
                review=review_obj,
                text=row[2],
                author=user_obj,
